...
public class HasTableViewTests
{
    ...
    //    _hasTableView.Filters = [
    //        new(){Key = "InvalidFilterKey", Value = "Value" }
    //    ];
    ...
    //[Fact]
    //public void Validate_WithNotAllowedValues_ThrowValidationException()
    //{
    //    // Arrange
    //    HashSet<string>? allowedFilters = ["Name", "Age", "Country"];
    //    HashSet<string>? allowedSorting = ["Name", "CreatedAt"];
    //    _hasTableView.Filters = new Dictionary<string, string>
    //    {
    //        { "InvalidFilter", "Value" }
    //    };
    //    _hasTableView.SortBy = "InvalidSort";
    //    // Act & Assert
    //    Assert.Throws<ValidationException>(() => _hasTableView.Validate(allowedFilters, allowedSorting));
    //}
    //[Fact]
    //public void Validate_WithAllowedValues_DoNotThrowValidationException()
    //{
    //    // Arrange
    //    HashSet<string>? allowedFilters = ["Name", "Age", "Country"];
    //    HashSet<string>? allowedSorting = ["Name", "CreatedAt"];
    ...
    //    _hasTableView.SortBy = "CreatedAt";
    //    // Act & Assert
    //    var exception = Record.Exception(() => _hasTableView.Validate(allowedFilters, allowedSorting));
    //    Assert.Null(exception);
    //}
